...
import type { ArbWasm, ArbWasmInterface } from "../../arbWasm/ArbWasm";
...
export class ArbWasm__factory {
  ...
  static createInterface(): ArbWasmInterface {
    return new Interface(_abi) as ArbWasmInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): ArbWasm {
    return new Contract(address, _abi, runner) as unknown as ArbWasm;
  }
}
